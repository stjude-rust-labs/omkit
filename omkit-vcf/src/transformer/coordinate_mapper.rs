...
/// State produced by the [`CoordinateMapper`] for downstream transformers.
#[derive(Clone, Debug)]
pub struct CoordinateMapperState {
    /// Whether the liftover mapped to the negative strand.
    pub negative_strand: bool,

    /// A snapshot of the record before coordinate mapping was applied.
    pub original: noodles::vcf::variant::RecordBuf,
}

impl Extension for CoordinateMapperState {}
